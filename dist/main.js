...
var serializer = require('form-serialize'),
    Backbone = require('Backbone'),
    _ = require('underscore');

var $ = global.jQuery ? global.jQuery : (console.log('jQuery is not defined in the global scope.'), {});
...
module.exports = function (Model) {
    ...
    return Backbone.Collection.extend({
        ...
        initialize: function initialize() {
            ...
            _.bindAll(this, 'validateClient', 'getRawValidationErrors', 'getValidationErrorsHtml', 'appendValidationErrors', 'clearValidationErrors');
        ...
        validateClient: function validateClient() {
            ...
            var validity = this.models.map(function (model) {

                return model.validate();
            });

            return validity.every(function (valid) {
         ...
         */
        getRawValidationErrors: function getRawValidationErrors() {

            return this.models.reduce(function (prev, inputModel) {

                var inputModelErrors = inputModel.get('errorMessages'),
         ...
         */
        getValidationErrorsHtml: function getValidationErrorsHtml() {

            return this.getRawValidationErrors().reduce(function (prev, modelErrors) {

                // Turn error strings into HTML
                var errorHTML = modelErrors.errors.reduce(function (prevError, validationErrors) {
        ...
        clearValidationErrors: function clearValidationErrors() {
            ...
            this.models.forEach(function (validationModel) {
                ...
                var $model = $('#' + validationModel.get('id'));
         ...
         * @return {void}
         */
        appendValidationErrors: function appendValidationErrors() {
         ...
         */
        getSerializedData: function getSerializedData(formId) {
...
},{"Backbone":1,"form-serialize":2,"underscore":4}],6:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./collections/collection-form":5,"./models/model-form-file":8,"./models/model-form-input":10,"./models/model-form-input-email":9,"./models/model-form-money":11,"./models/model-form-password":12,"./models/model-form-radio-checkbox":13,"./models/model-form-recaptcha":14,"./models/model-form-select":15,"./models/model-form-textarea":16,"./views/view-form-input":18,"./views/view-form-input-money":17,"./views/view-form-select":19}],7:[function(require,module,exports){
'use strict';
...
module.exports = BaseModel.extend({
    initialize: function initialize() {
        ...
        this.defaults = _.extend(BaseModel.defaults, {
            uploadedFileCount: 0,
            requiredFileCount: 1
        });
    ...
    /**
     * Validates Number of Successfully Uploaded Files
     * @return {void}
     */
    validateFileCount: function validateFileCount() {

        var uploadedFiles = +this.get('uploadedFileCount'),
            requiredFiles = +this.get('requiredFileCount'),
            count = uploadedFiles === 1 ? 'photo' : 'photos';
...
},{"./model-form-base":7,"underscore":4}],9:[function(require,module,exports){
'use strict';
...
module.exports = FormInputModel.extend({
    initialize: function initialize() {
        ...
        this.defaults = _.extend(FormInputModel.defaults, {
            type: 'email',
            min: 3,
            pattern: '\\S+@\\S'
        });
...
},{"./model-form-input":10,"underscore":4}],10:[function(require,module,exports){
'use strict';
...
module.exports = FormBaseModel.extend({
    initialize: function initialize() {
        ...
        this.defaults = _.extend(FormBaseModel.defaults, {
            value: '',
            type: 'text',
            min: 1
        });
    ...
    validateLength: function validateLength() {
        ...
        if (max && value.length > max) {
            ...
            this.setError.call(this, 'Please enter a value less than ' + max + ' characters long.');
        }

        if (min && value.length < min) {

            this.setError.call(this, 'Please enter a value more than ' + min + ' characters long.');
        }
    }
});

},{"./model-form-base":7,"underscore":4}],11:[function(require,module,exports){
'use strict';
...
module.exports = FormBaseModel.extend({
     ...
     * @return {void}
     */
    stripMoney: function stripMoney() {
        ...
        if (Number.isNaN(parsedValue)) {
            ...
            if (value.charAt(0) === currencySymbol) {
                ...
                if (Number.isNaN(newValue)) {
                    ...
                    Math.min(newValue, this.model.get('max'));
                }
            }
...
},{"./model-form-input":10,"underscore":4}],12:[function(require,module,exports){
'use strict';

var FormInputModel = require('./model-form-input');
...
},{"./model-form-input":10}],13:[function(require,module,exports){
'use strict';
...
module.exports = FormBaseModel.extend({
     ...
     * @return {void}
     */
    validateOptionCount: function validateOptionCount() {

        var radioCount = this.get('checkedOptions').toArray().some(function ($option) {
        ...
        if (radioCount < this.get('requiredNumber')) {
            ...
            this.setError.call(this, 'Please select at least ' + requiredNumber + ' ' + errorMessage);
        }
    }
});

},{"./model-form-base":7,"underscore":4}],14:[function(require,module,exports){
/* eslint no-undef: 0 */
...
module.exports = FormBaseModel.extend({
    ...
    validateRecaptcha: function validateRecaptcha() {
        ...
        var recaptchaId = window.recaptchaIds[this.get('id')];
...
},{"./model-form-base":7,"underscore":4}],15:[function(require,module,exports){
'use strict';
...
},{"./model-form-base":7,"underscore":4}],16:[function(require,module,exports){
'use strict';

var FormBaseInputModel = require('./model-form-input');
...
},{"./model-form-input":10}],17:[function(require,module,exports){
'use strict';
...
module.exports = function (model) {
    ...
    return InputView.extend({
         ...
         * @return {void}
         */
        moneyChange: function moneyChange(ev) {

            if (ev.currentTarget.value !== '') {

                var value = this.formatPrice.call(this, this.$el.val()),
                ...
                if (value && String(value).charAt(0) !== currencySymbol) {
                    ...
                    this.$el.val('' + currencySymbol + parseFloat(value).toFixed(2));
                } else {
        ...
        formatPrice: function formatPrice(value) {
            ...
            if (Number.isNaN(formattedPrice)) {
                ...
                if (String(value).charAt(0) === currencySymbol) {
                    ...
                    formattedPrice = Math.min(maxPrice, parseFloat(String(price).slice(1)));
...
},{"../models/model-form-input":10,"./view-form-input":18,"underscore":4}],18:[function(require,module,exports){
'use strict';
